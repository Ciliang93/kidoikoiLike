    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" id="finishedEvents" href="archives.php">Evènements archivés</a>
                </li>
            </ul>
...
<div class="container mainDiv col-xs-11 col-sm-8 col-md-8 col-lg-8">
    <h3 class="h3">Vos évènements archivés</h3>
    <div class="row">
        <?php
        $dbManager = new DBManager();
        $db = $dbManager->connect();
        $eventManager = new EvenementManager($db);
        $result = $eventManager->recupEvenementsLiesArchives($_SESSION['pseudoUtilisateur']);
        if($result){
            foreach ($result as $key => $row){
                echo  '
                <div class="card col-sm-5 col-md-3 col-lg-3 col-xl-3">
                    <img class="card-img-top imageEvents" src="../uploads/defaultArchived.png" alt="img card">
                    <div class="card-body">
